...
//
 //           );
  //          print json_encode($finresult);
	 ...
	 public function driver_getmarker()
    {       
        $params['id']=$this->input->get('id');
    	$id = $params['id'];
    	
        $result = $this->model_web_service->drivergetmarker($id);

       
		$table = 'markers_details';
        $select_data = "*";
        ...
        $query = $this->db->get($table);  //--- Table name = User
        $markers_details = $query->result_array();
           
        $finresult['markers_details']=$markers_details;
...
//http://v1technology.co.uk/demo/naqil/naqilcom/Source/web_service/car_type
	...
	public function driver_setmarker()
    {
        
        $id= $this->input->post('id');
                      
        	
        $driver_setmarkers = $this->model_web_service->driver_setmarker_model($id); 
        ...
        $finresult = array('status' => 'success', 'message' => 'Successfully Signed up', 'code' => 'success','markers_details' => $markers_details,'country_detail' => $result_setting);
